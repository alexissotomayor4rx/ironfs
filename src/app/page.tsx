...
export default function Home() {
  return (
    <>
      ...
      >
        {/* Decorative SVG swoosh — TOP RIGHT */}
        <svg
          viewBox="0 0 600 220"
        ...
        >
          {/* Outer dark red wing */}
          <path
            d="M 580 10 C 420 -10, 120 60, 10 180 C 80 130, 300 60, 580 80 Z"
            fill="#7B0D1E"
          />
          {/* Mid red wing */}
          <path
            d="M 560 50 C 400 30, 150 90, 30 190 C 100 145, 310 85, 560 105 Z"
            fill="#C0152A"
          />
          {/* Inner coral/salmon wing */}
          <path
            d="M 530 90 C 380 75, 200 120, 60 200 C 130 168, 330 115, 530 130 Z"
            fill="#E85C6A"
          />
        </svg>

        {/* Decorative SVG swoosh — BOTTOM LEFT (mirrored) */}
        <svg
          viewBox="0 0 600 220"
          xmlns="http://www.w3.org/2000/svg"
          style={{
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          <div style={{ maxWidth: "800px" }}>
            ...
            >
              Delivering high-end structural steel and iron fabrication for
              commercial and industrial projects across Maryland, Virginia and
              DC.
            </p>
      ...
      <section id="services" className="section container">
        <div style={{ textAlign: "center", marginBottom: "5rem" }}>
          <h2 className="section-title" style={{ margin: 0 }}>
            The Standard of{" "}
            <span style={{ color: "var(--color-primary)" }}>Excellence</span>
          </h2>
          <p
            style={{
              marginTop: "1.5rem",
          ...
          >
            Reliable, heavy-duty, and tech-forward. We merge traditional
            craftsmanship with modern engineering principles.
          </p>
        </div>
        ...
        <div className="container">
          ...
          >
            <div>
              ...
              >
                A selection of our recent structural steel, staircase, and
            ...
            <div className="masonry-item large">
              ...
              <div
                style={{
                  ...
                  padding: "2rem",
                  background:
                    "linear-gradient(to top, rgba(28,40,51,0.9), transparent)",
                  color: "#FFF",
                }}
              >
                <span
      ...
      <section id="quote" className="section container">
        ...
        >
          ...
          >
            Submit your schematics or talk to one of our engineers today. We
            provide comprehensive quotes within 48 hours.
          </p>
          <div
            style={{
              display: "flex",
